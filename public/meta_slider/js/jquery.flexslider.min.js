	...
	e.flexslider = function (a, n) {
		...
		e.data(a, "flexslider", i), g = {
			init: function () {
				...
				}), i.vars.pauseInvisible && g.pauseInvisible.isHidden() || (i.vars.initDelay > 0 ? i.startTimeout = setTimeout(i.play, i.vars.initDelay) : i.play())), f && g.asNav.setup(), l && i.vars.touch && g.touch(), (!m || m && i.vars.smoothHeight) && e(window).on("resize orientationchange focus", g.resize), i.find("img").attr("draggable", "false"), setTimeout(function () {
					i.vars.start(i)
				}, 200)
			},
			asNav: {
				setup: function () {
					i.asNav = !0, i.animatingTo = Math.floor(i.currentSlide / i.move), i.currentItem = i.currentSlide, i.slides.removeClass(r + "active-slide").eq(i.currentItem).addClass(r + "active-slide"), o ? (a._slider = i, i.slides.each(function () {
						...
						var a, n = e(this),
							s = n.index();
						a = i.vars.rtl ? -1 * (n.offset().right - e(i).scrollLeft()) : n.offset().left - e(i).scrollLeft(), a <= 0 && n.hasClass(r + "active-slide") ? i.flexAnimate(i.getTarget("prev"), !0) : e(i.vars.asNavFor).data("flexslider").animating || n.hasClass(r + "active-slide") || (i.direction = i.currentItem < s ? "next" : "prev", i.flexAnimate(s, i.vars.pauseOnAction, !1, !0, !0))
					})
				}
			},
			controlNav: {
				...
				update: function (t, a) {
					i.pagingCount > 1 && "add" === t ? i.controlNavScaffold.append(e('<li><a href="#"></a></li>')) : 1 === i.pagingCount ? i.controlNavScaffold.find("li").remove() : i.controlNav.eq(a).closest("li").remove(), i.controlNavScaffold.find("li").each(function (t, a) {
						e(a).find("a").text(t + 1)
					}), g.controlNav.set(), i.pagingCount > 1 && i.pagingCount !== i.controlNav.length ? i.update(a, t) : g.controlNav.active()
				}
			},
			directionNav: {
				setup: function () {
			...
			touch: function () {
				...
				function t(e) {
					...
					if (t) {
						var n = -e.translationX,
							i = -e.translationY;
						return b += u ? i : n, d = (t.vars.rtl ? -1 : 1) * b, x = u ? Math.abs(b) < Math.abs(-n) : Math.abs(b) < Math.abs(-i), e.detail === e.MSGESTURE_FLAG_INERTIA ? void setImmediate(function () {
							a._gesture.stop()
						}) : void((!x || Number(new Date) - f > 500) && (e.preventDefault(), !m && t.transitions && (t.vars.animationLoop || (d = b / (0 === t.currentSlide && b < 0 || t.currentSlide === t.last && b > 0 ? Math.abs(b) / c + 2 : 1)), t.setProps(l + d, "setTouch"))))
					}
				}
				...
				function n(e) {
					...
					if (t) {
						...
						d && x ? t.vars.slideshow && t.play() : d ? !t.vars.pauseOnAction && t.play() || (t.vars.slideshow = !1) : t.vars.slideshow && !t.vars.pauseOnAction && t.play() || (t.vars.slideshow = !1), s = null, r = null, d = null, l = null, b = 0
					}
				}
				...
				o ? (a.style.msTouchAction = "none", a._gesture = new MSGesture, a._gesture.target = a, a.addEventListener("MSPointerDown", e, !1), a._slider = i, a.addEventListener("MSGestureChange", t, !1), a.addEventListener("MSGestureEnd", n, !1)) : (g = function (e) {
					i.animating ? e.preventDefault() : (window.navigator.msPointerEnabled || 1 === e.touches.length) && (i.pause(), c = u ? i.h : i.w, f = Number(new Date), y = e.touches[0].pageX, w = e.touches[0].pageY, l = p && v && i.animatingTo === i.last ? 0 : p && v ? i.limit - (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo : p && i.currentSlide === i.last ? i.limit : p ? (i.itemW + i.vars.itemMargin) * i.move * i.currentSlide : v ? (i.last - i.currentSlide + i.cloneOffset) * c : (i.currentSlide + i.cloneOffset) * c, s = u ? w : y, r = u ? y : w, a.addEventListener("touchmove", h, !1), a.addEventListener("touchend", S, !1))
				}, h = function (e) {
					y = e.touches[0].pageX, w = e.touches[0].pageY, d = u ? s - w : (i.vars.rtl ? -1 : 1) * (s - y), x = u ? Math.abs(d) < Math.abs(y - r) : Math.abs(d) < Math.abs(w - r);
					var t = 500;
					(!x || Number(new Date) - f > t) && (e.preventDefault(), !m && i.transitions && (i.vars.animationLoop || (d /= 0 === i.currentSlide && d < 0 || i.currentSlide === i.last && d > 0 ? Math.abs(d) / c + 2 : 1), i.setProps(l + d, "setTouch")))
				}, S = function (e) {
					...
					a.removeEventListener("touchend", S, !1), d && x ? i.vars.slideshow && i.play() : d ? !i.vars.pauseOnAction && i.play() || (i.vars.slideshow = !1) : i.vars.slideshow && !i.vars.pauseOnAction && i.play() || (i.vars.slideshow = !1), s = null, r = null, d = null, l = null
			...
			i.transitions && (n = i.isFirefox ? u ? "translate3d(0," + n + ",0)" : "translate3d(" + (parseInt(n) + "px") + ",0,0)" : u ? "translate3d(0," + n + ",0)" : "translate3d(" + ((i.vars.rtl ? -1 : 1) * parseInt(n) + "px") + ",0,0)", a = void 0 !== a ? a / 1e3 + "s" : "0s", i.container.css("-" + i.pfx + "-transition-duration", a), i.container.css("transition-duration", a)), i.args[i.prop] = n, (i.transitions || void 0 === a) && i.container.css(i.args), i.container.css("transform", n)
		}, i.setup = function (t) {
			if (m) i.vars.rtl ? i.slides.css({
				...
				"init" === t && (i.viewport = e('<div class="' + r + 'viewport"></div>').css({
					overflow: "hidden",
					position: "relative"
				}).appendTo(i).append(i.container), i.cloneCount = 0, i.cloneOffset = 0, v && (n = e.makeArray(i.slides).reverse(), i.slides = e(n), i.container.empty().append(i.slides))), i.vars.animationLoop && !p && (i.doMath(), i.slides.css({
					width: i.computedW,
					marginRight: i.computedM,
					"float": "left",
					display: "block"
				}), i.cloneCount = 2, i.cloneOffset = 1, "init" !== t && i.container.find(".clone").remove(), i.container.append(g.uniqueID(i.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(g.uniqueID(i.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))), i.newSlides = e(i.vars.selector, i), a = v ? i.count - 1 - i.currentSlide + i.cloneOffset : i.currentSlide + i.cloneOffset, u && !p ? (i.container.height(200 * (i.count + i.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function () {
					i.newSlides.css({
						display: "block"
