			            ...
			            <div class="item col-xs-12 col-sm-4 post-{{$ebook['id']}} product type-product status-publish has-post-thumbnail product_cat-budgeting-and-finance product_cat-creative-thinking product_cat-fantasy product_cat-romance product_cat-sales-and-marketting product_tag-romance-stories product_tag-suspense last instock shipping-taxable purchasable product-type-simple">
			               <div class="product-wrap">
			                  <div class="product-image">
			                     <div class="catalog-image">
			                        <a href="ebook/{{$ebook['id']}}">
			                           <img width="207" height="265" src="{{ asset('public/images/ebook5.png') }}" class="attachment-bookstore_product_thumb size-bookstore_product_thumb wp-post-image" alt="ebook" sizes="(max-width: 207px) 100vw, 207px">                        
			                     ...
			                     <div class="product-buttons">
			                        <div class="add-to-cart-btn">
			                        	<a href="#" rel="nofollow" data-product_id="73" data-product_sku="" data-quantity="1" class="button">Xem chi tiết</a>
			                        </div>
			                        <div class="clear"></div>
			                     </div>
			                  ...
			                  <div class="product-content">
			                     <h4 class="product_title"><a class="bks_product_title_link" href="ebook/{{$ebook['id']}}">{{$ebook['name']}}</a></h4>
			                  </div>
			                  <!-- end product-content -->
			               </div>
			            </div>
