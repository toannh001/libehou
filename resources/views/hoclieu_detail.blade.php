				...
				@foreach($hoclieu_detail->list as $hoclieu)
				 <div itemscope="" itemtype="http://schema.org/Product" id="product-76" class="post-76 product type-product status-publish has-post-thumbnail product_cat-budgeting-and-finance product_cat-creative-thinking product_cat-fantasy product_cat-historical-fiction product_cat-people-management product_cat-personal-finance product_cat-romance product_cat-science-fiction product_tag-historical product_tag-romance-stories first instock featured shipping-taxable purchasable product-type-simple">
					<div class="images col-sm-6 hinhanhchitiet">
					   <a href="#" itemprop="image" class="woocommerce-main-image zoom" title="" data-rel="prettyPhoto"><img width="350" height="450" src="{{ asset('public/images/hldt.png') }}" class="attachment-shop_single size-shop_single wp-post-image" alt="book7" title="book7"></a>
					</div>
					<div class="summary entry-summary col-sm-6 noidungchitiet">
					   ...
					   <div class="description motahoclieu">
						  <p><span class="posted_in">Mô tả: </p>
					   </div>					   
					   <div class="clear"></div>					   
											...
											<div class="vc_tta-panel-body">
												 <div class='woocommerce bks-product-slider '>
													<div class="content_richmedia">
														...
														<p><img class="image_hoclieu" src="{{ asset('public/images/start-16.png') }}"/><a href="downloadrich/{{$richmedia->id}}">{{$richmedia->name}}<a></p>
														@endforeach
													</div>
												</div>
											</div>
											...
											<div class="vc_tta-panel-body">
												 <div class='woocommerce bks-product-slider '>
													<div class="content_richmedia">
														...
														<p><img class="image_hoclieu" src="{{ asset('public/images/document-16.png') }}"/><a href="http://{{$_SERVER['HTTP_HOST']}}/hoclieu/downloadtext/{{$text->id}}">{{$text->name}}<a></p>
														@endforeach
													</div>
												</div>
											</div>
							 ...
							 <div class="vc_column-inner ">
								<div class="wpb_wrapper">
								   <div class='bks-heading '>
									  <h3 class='bks-title'><span style='font-size:18px;color:#333333;line-height:21px'>HỌC LIỆU CÙNG NGÀNH</span></h3>
															  ...
															  <div class="product-wrap">
																 ...
																 <div class="product-image">
																	<div class="catalog-image">
																	   <a href="#">
																		  <img width="207" height="265" src="{{ asset('public/images/hldt.png') }}" class="attachment-bookstore_product_thumb size-bookstore_product_thumb wp-post-image" alt="book11"  sizes="(max-width: 207px) 100vw, 207px" />                        
																	...
																	<div class="product-buttons">
																	   <div class="add-to-cart-btn"><a href="#" rel="nofollow" data-product_id="{{ $product->id }}" data-product_sku="" data-quantity="1" class="button add_to_cart_button ajax_add_to_cart product_type_simple">Xem học liệu</a></div>																	   
																	   <div class="clear"></div>
																	</div>
																 </div>
																 <!-- end product-image -->
																 <div class="product-content">
																	<h4 class="product_title"><a class="bks_product_title_link" href="#">{{ $product->name }}</a></h4>
																 </div>
																 <!-- end product-content -->   
															  </div>
														   </div>
