		<div id="content" role="main">
                                 ...
                                 <div class='t3-module module border-right col-sm-offset-2 col-lg-offset-0 '>
                                    <div class='custom border-right col-sm-offset-2 col-lg-offset-0'>
                                       <div class='jb-icon-with-description'>
                                          ...
                                          <h4 style='color:#f7f7f7'>24/7 CUSTOMER SUPPORT</h4>
                                 ...
                                 <div class='t3-module module border-right col-sm-offset-2 col-lg-offset-0 '>
                                    <div class='custom border-right col-sm-offset-2 col-lg-offset-0'>
                                       <div class='jb-icon-with-description'>
                                          ...
                                          <h4 style='color:#f7f7f7'>FREE SHIPPING WORLD WIDE</h4>
                                 ...
                                 <div class='t3-module module col-sm-offset-2 col-lg-offset-0 '>
                                    <div class='custom col-sm-offset-2 col-lg-offset-0'>
                                       <div class='jb-icon-with-description'>
                                          ...
                                          <h4 style='color:#f7f7f7'>MONEY BACK GUARANTEE</h4>
                                 ...
                                 <div class='dis-bottom-left-img'>
                                    ...
                                    <div class='dis-bottom-left-content'>
                                       <div class='dis-bottom-left-text'>
                                          <h6 style='color:#323232'>SHOP CATEGORY</h6>
                                          <h2 style='color:#27ae61'>E-BOOKS</h2>
                                          <a href='#' style='color:#323232' class='btn-link'>Xem học liệu <em class='fa fa-long-arrow-right'></em></a>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="vc_general vc_tta vc_tta-tabs vc_tta-color-grey vc_tta-style-classic vc_tta-shape-rounded vc_tta-spacing-1 vc_tta-tabs-position-top vc_tta-controls-align-left">
                                 <div class="vc_tta-tabs-container">
                                    <ul class="vc_tta-tabs-list">
                                       <li class="vc_tta-tab vc_active" data-vc-tab><a href="#CNTT" data-vc-tabs data-vc-container=".vc_tta"><span class="vc_tta-title-text">Công nghệ thông tin</span></a></li>
									   ...
									   <li class="vc_tta-tab" data-vc-tab><a href="#TCNH" data-vc-tabs data-vc-container=".vc_tta"><span class="vc_tta-title-text">Tài chính ngân hàng</span></a></li>
									</ul>
                                 </div>
                                 <div class="vc_tta-panels-container">
                                    <div class="vc_tta-panels">
                                       <div class="vc_tta-panel vc_active" id="CNTT" data-vc-content=".vc_tta-panel-body">
                                          <div class="vc_tta-panel-heading">
                                             <h4 class="vc_tta-panel-title"><a href="#CNTT" data-vc-accordion data-vc-container=".vc_tta-container"><span class="vc_tta-title-text">Best Selling</span></a></h4>
                                          </div>
                                       ...
                                       <div class="vc_tta-panel" id="KT" data-vc-content=".vc_tta-panel-body">
                                          <div class="vc_tta-panel-heading">
												 <h4 class="vc_tta-panel-title"><a href="#KT" data-vc-accordion data-vc-container=".vc_tta-container"><span class="vc_tta-title-text">Text Books</span></a></h4>
											  </div>
											  <div class="vc_tta-panel-body">
												 <div class='woocommerce bks-product-slider '>
													<div class='carousel-controls'>
                                       ...
                                       <div class="vc_tta-panel" id="LKT" data-vc-content=".vc_tta-panel-body">
                                          <div class="vc_tta-panel-heading">
												 <h4 class="vc_tta-panel-title"><a href="#LKT" data-vc-accordion data-vc-container=".vc_tta-container"><span class="vc_tta-title-text">Text Books</span></a></h4>
											  </div>
											  <div class="vc_tta-panel-body">
												 <div class='woocommerce bks-product-slider '>
													<div class='carousel-controls'>
									   ...
									   <div class="vc_tta-panel" id="NNA" data-vc-content=".vc_tta-panel-body">
											  <div class="vc_tta-panel-heading">
												 <h4 class="vc_tta-panel-title"><a href="#NNA" data-vc-accordion data-vc-container=".vc_tta-container"><span class="vc_tta-title-text">Text Books</span></a></h4>
											  </div>
											  <div class="vc_tta-panel-body">
												 <div class='woocommerce bks-product-slider '>
													<div class='carousel-controls'>
									   ...
									   <div class="vc_tta-panel" id="QTKD" data-vc-content=".vc_tta-panel-body">
											  <div class="vc_tta-panel-heading">
												 <h4 class="vc_tta-panel-title"><a href="#QTKD" data-vc-accordion data-vc-container=".vc_tta-container"><span class="vc_tta-title-text">Text Books</span></a></h4>
											  </div>
											  <div class="vc_tta-panel-body">
												 <div class='woocommerce bks-product-slider '>
													<div class='carousel-controls'>
									   ...
									   <div class="vc_tta-panel" id="TCNH" data-vc-content=".vc_tta-panel-body">
											  <div class="vc_tta-panel-heading">
												 <h4 class="vc_tta-panel-title"><a href="#TCNH" data-vc-accordion data-vc-container=".vc_tta-container"><span class="vc_tta-title-text">Text Books</span></a></h4>
											  </div>
											  <div class="vc_tta-panel-body">
												 <div class='woocommerce bks-product-slider '>
													<div class='carousel-controls'>
            ...
            <div class="vc_row wpb_row vc_row-fluid vc_custom_1454683539961 vc_row-has-fill">
               <div class="page-container">
                  <div id='bks_slider_JXXco' class='bks-testimonial-slider ' style='color:#ffffff;font-size:18px;font-style=13'>
                     <ul id='bks-testimonial-slider' class='gallery list-unstyled cS-hidden'>
                        <li data-thumb="http://wp.acmeedesign.com/bookstore/wp-content/uploads/2016/02/team-4-150x150.jpg">
                           <div class="testimonial-content">
                              <div>
                                 <p>I can say without doubt that your team are a true pleasure to work with. They are easy to communicate with which make process smooth. Highly recommended.</p>
                              </div>
                              <p class="author_details"></p>
                           </div>
                           <!-- testimonial-content -->
                        </li>
                        <li data-thumb="http://wp.acmeedesign.com/bookstore/wp-content/uploads/2016/02/team-5-150x150.jpg">
                           <div class="testimonial-content">
                              <div>
                                 <p>You&#8217;re the best! You did an amazing and perfect job … We have received many positive feedbacks on our new site since the launch. Great thanks again.</p>
                              </div>
                              <p class="author_details"></p>
                           </div>
                           <!-- testimonial-content -->
                        </li>
                        <li data-thumb="http://wp.acmeedesign.com/bookstore/wp-content/uploads/2016/02/team-1-150x150.jpg">
                           <div class="testimonial-content">
                              <div>
                                 <p>Your staff has been nothing less than professional and respectful. They are super patient and really listened to what I wanted. I would give you the top stars!</p>
                              </div>
                              <p class="author_details"></p>
                           </div>
                           <!-- testimonial-content -->
                        </li>
                        <li data-thumb="http://wp.acmeedesign.com/bookstore/wp-content/uploads/2016/02/team-3-150x150.jpg">
                           <div class="testimonial-content">
                              <div>
                                 <p>I can say without doubt that your team are a true pleasure to work with. They are easy to communicate with which make process smooth. Highly recommended.</p>
                              </div>
