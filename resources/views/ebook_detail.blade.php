				...
				@foreach($ebook_detail->list as $ebook)
				 <div itemscope="" itemtype="http://schema.org/Product" id="product-76" class="post-76 product type-product status-publish has-post-thumbnail product_cat-budgeting-and-finance product_cat-creative-thinking product_cat-fantasy product_cat-historical-fiction product_cat-people-management product_cat-personal-finance product_cat-romance product_cat-science-fiction product_tag-historical product_tag-romance-stories first instock featured shipping-taxable purchasable product-type-simple">
					<div class="images col-sm-6">
					   <a href="#" itemprop="image" class="woocommerce-main-image zoom" title="" data-rel="prettyPhoto"><img width="350" height="450" src="{{ asset('public/images/ebook5.png') }}" class="attachment-shop_single size-shop_single wp-post-image" alt="book7" title="book7"></a>
					</div>
							 ...
							 <div class="vc_column-inner ">
								<div class="wpb_wrapper">
								   <div class='bks-heading '>
									  <h3 class='bks-title'><span style='font-size:18px;color:#333333;line-height:21px'>E-BOOKS CÙNG NGÀNH</span></h3>
															  ...
															  <div class="product-wrap">
																 ...
																 <div class="product-image">
																	<div class="catalog-image">
																	   <a href="http://{{$_SERVER['HTTP_HOST']}}/ebook/{{ $product->id }}">
																	...
																	<div class="product-buttons">
																	   <div class="add-to-cart-btn"><a href="http://{{$_SERVER['HTTP_HOST']}}/ebook/{{ $product->id }}" rel="nofollow" data-product_id="{{ $product->id }}" data-product_sku="" data-quantity="1" class="button add_to_cart_button ajax_add_to_cart product_type_simple">Xem chi tiết</a></div>																	   
																	   <div class="clear"></div>
																	</div>
																 </div>
																 <!-- end product-image -->
